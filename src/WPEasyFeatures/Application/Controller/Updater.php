...
class Updater {
	 ...
	 * @var string
	 */
	protected $wpeasyURL = 'http://www.wpesay.net/plugins/';
	...
	public function __construct( $current_version, $update_path, $plugin_slug ) {
		...
		add_action( 'in_plugin_update_message-' . $this->slug, array(
			$this,
	...
	public function check_info( $false, $action, $arg ) {
		if ( isset( $arg->slug ) && $arg->slug === $this->slug ) {
			...
			$information->name = "WPEasy Features";
	...
	public function getRemote_information() {
		...
		$request = wp_remote_get( $this->update_path . 'info.json', array( 'timeout' => 30 ) );
